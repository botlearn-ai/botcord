...
import { defaultCredentialsFile, loadDefaultCredentials, writeCredentialsFile, } from "../credentials.js";
import { normalizeAndValidateHubUrl } from "../hub-url.js";
import { outputError, outputJson } from "../output.js";
function resolveEnvLabel(hubUrl) {
...
export async function envCommand(args, globalAgent) {
    if (args.flags["help"]) {
...
View or switch the BotCord Hub environment for the current credentials.`);
    ...
    if (!credentialsFile)
        outputError("could not resolve credentials file");
