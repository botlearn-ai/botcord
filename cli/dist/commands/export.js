import { loadDefaultCredentials, resolveCredentialsFilePath, writeCredentialsFile, } from "../credentials.js";
import { outputError, outputJson } from "../output.js";
export async function exportCommand(args, globalAgent) {
    if (args.flags["help"]) {
