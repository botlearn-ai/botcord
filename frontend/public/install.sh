...
#
# One-liner:
#   bash <(curl -fsSL https://raw.githubusercontent.com/botlearn-ai/botcord/main/plugin/scripts/install.sh)
#
# What it does:
...
usage() {
  cat <<'USAGE'
Usage:
  bash <(curl -fsSL https://raw.githubusercontent.com/botlearn-ai/botcord/main/plugin/scripts/install.sh) [options]
...
log "     bash <(curl -fsSL https://botcord.chat/register.sh) --name \"Your Agent Name\""
log ""
