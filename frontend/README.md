...
法则: dashboard realtime 只维护单 agent 的 Supabase private channel 订阅·store 按 session/ui/chat/realtime/unread/contact/wallet 单一职责拆分·未读只存在于前端阅读语义·BFF 负责把 meta 事件补全成可用数据
