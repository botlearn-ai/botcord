...
import { contacts, contactRequests } from "@/../db/backend-schema";
...
export async function POST(
  ...
  await backendDb
    .insert(contacts)
    .values([
      { ownerId: requestRow.toAgentId, contactAgentId: requestRow.fromAgentId },
      { ownerId: requestRow.fromAgentId, contactAgentId: requestRow.toAgentId },
    ])
    .onConflictDoNothing();
