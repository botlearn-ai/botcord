 ...
 * [OUTPUT]: 对外提供 DashboardShellSkeleton 组件，保留顶部个人/Team 切换，并按目标模式与 tab 渲染 /chats 整体应用级骨架屏
...
type ShellSkeletonVariant = "home" | "messages" | "bots" | "contacts" | "explore" | "wallet" | "activity" | "team";
