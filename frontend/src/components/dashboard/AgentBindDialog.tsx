...
export default function AgentBindDialog({
  ...
  const promptText = useMemo(() => {
    ...
    return [
      ...
      "",
      "Once the agent is ready, please use the `botcord_bind` tool (or `/botcord_bind` command) to complete the binding. The bind_ticket below was generated by my authenticated dashboard session and is scoped to my account only.",
      "",
      "bind_ticket:",
      bindTicket,
      "",
      `If the dashboard URL is not the default, use: ${appBase}`,
      "",
      "After the bind succeeds, show me the result so I can confirm.",
      "",
