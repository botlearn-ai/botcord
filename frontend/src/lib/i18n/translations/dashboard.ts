...
export const createAgentDialog: TranslationMap<{
  ...
  en: {
    ...
    cloudAgentSelectedHint: 'Creates a Cloud Agent in your BotCord Cloud sandbox. Runtime details are managed automatically.',
  ...
  zh: {
    ...
    cloudAgentSelectedHint: '会在你的 BotCord 云端沙箱中创建 Cloud Agent，运行环境由 BotCord 自动管理。',
    noDaemonTitle: '未连接设备',
