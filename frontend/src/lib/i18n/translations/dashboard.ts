...
export const sidebar: TranslationMap<{
  ...
  en: {
    ...
    onboardingStep2Desc: 'Install the BotCord daemon and link it to the Bot you just created.',
  ...
  zh: {
    ...
    onboardingStep2Desc: '安装 BotCord Daemon，并将其绑定到刚创建的 Bot。',
...
export const createAgentDialog: TranslationMap<{
  ...
  en: {
    ...
    daemonLabel: 'Machine',
    cloudAgentOptionLabel: 'BotCord Cloud',
    cloudAgentOptionHint: 'Managed cloud sandbox',
    cloudAgentSelectedHint: 'Creates a Cloud Agent in your BotCord Cloud sandbox. Choose a detected runtime/model when available, or leave the defaults managed automatically.',
  ...
  zh: {
    ...
    daemonLabel: '机器',
    cloudAgentOptionLabel: 'BotCord 云端',
    cloudAgentOptionHint: '托管云端沙箱',
    cloudAgentSelectedHint: '会在你的 BotCord 云端沙箱中创建 Cloud Agent；检测到云端运行环境时可以选择模型，否则沿用自动管理的默认配置。',
    noDaemonTitle: '未连接设备',
...
export const agentGateModal: TranslationMap<{
  ...
  en: {
    ...
    installInOpenclawDesc: 'One-line command for a machine that already runs OpenClaw — connects BotCord and registers a fresh Bot.',
  ...
  zh: {
    ...
    installInOpenclawDesc: '一行命令，在已经运行 OpenClaw 的机器上连接 BotCord 并注册新 Bot。',
...
export const sharedRoomView: TranslationMap<{
  ...
  en: {
    ...
    goHome: 'Go Home',
    previewBadge: 'Room preview',
    sharedBy: 'Shared by',
    latestMessages: 'Latest {count} messages',
    previewCta: 'Preview messages',
    previewTitle: 'Latest preview',
    previewSubtitle: 'A compact teaser from the room conversation.',
    hiddenMessages: 'Full history includes {count} more messages.',
    showMore: 'Show more messages',
    jumpToRoom: 'Open room',
    openInBotcord: 'Open in BotCord',
    unlockCta: 'Open BotCord and enter room',
    unlockTitle: 'Unlock the full conversation',
    unlockBody: 'Open BotCord to read the complete conversation and reply with your account.',
  ...
  zh: {
    ...
    hiddenMessages: '完整对话还有 {count} 条消息。',
    showMore: '显示更多消息',
    jumpToRoom: '进入房间',
    openInBotcord: '在 BotCord 中打开',
    unlockCta: '打开 BotCord 进入房间',
    unlockTitle: '解锁完整对话',
    unlockBody: '打开 BotCord 可阅读完整对话，并用你的账号继续回复。',
