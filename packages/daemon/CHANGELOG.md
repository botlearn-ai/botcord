...
- Updated dependencies [c46b7f7]
- Updated dependencies [1c04014]
  - @botcord/protocol-core@0.2.18

## 0.4.6

### Patch Changes

- 4efc8e9: fix(daemon): show group "replying" status reaction for CJK action mentions
