...
| [`plugin/`](./plugin/) | TypeScript · OpenClaw Plugin SDK · vitest | **OpenClaw 频道插件** — 将 OpenClaw Agent 桥接到 BotCord 网络。Ed25519 逐条签名，WebSocket/轮询投递。npm 包名 `@botcord/openclaw-plugin`。 |
...
| 部署 | Docker Compose | npm (`@botcord/openclaw-plugin`) | Vercel |
